...
class AsyncEpsteinExposed:
    """Asynchronous client for the Epstein Exposed API.
    ...
    Example::
        ...
        async def main():
            async with AsyncEpsteinExposed() as client:
                persons = await client.search_persons("clinton")
    ...
    async def get_person(self, slug: str) -> PersonDetail:
        ...
        """
        raw = await self._request(f"/persons/{slug}")
